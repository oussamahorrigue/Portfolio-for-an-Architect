class Gallery {
    constructor(placement, id) {
        ...
        this.buttonL.setAttribute("src", "icons/arrl.png");
        this.buttonR = document.createElement("input");
        this.buttonR.setAttribute("type", "image");
        this.buttonR.setAttribute("src", "icons/arrr.png");
    ...
    source(nr) {
        ...
        return ("layoutA/" + this.dirc + "/ (" + nr + ")." + this.file);
    }
}
var instances = [];
function find(id) {
...
function menu() {
    if (p_menu == 0) {
        ...
        image.src = "icons/open_menu.gif";
        clearTimeout(x);
        x = setTimeout(() => { image.src = "icons/opened_menu.gif"; }, 450);
        p_menu = 1;
    }
    else {
        var image = document.getElementById("menu");
        image.src = "icons/close_menu.gif";
        clearTimeout(x);
        x = setTimeout(() => { image.src = "icons/closed_menu.gif"; }, 500);
        p_menu = 0;
    }
